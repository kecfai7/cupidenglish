      ...
      <section className="bg-white dark:bg-slate-900 border border-pink-300 dark:border-slate-800 rounded-3xl p-6 space-y-4 shadow-xl">
        ...
        <div className="relative">
          <textarea
            ...
            className="w-full h-28 p-4 rounded-2xl bg-pink-50/80 dark:bg-slate-950 border border-pink-300 dark:border-slate-700 text-slate-950 dark:text-white placeholder-slate-500 font-bold text-base leading-relaxed resize-none transition-all focus:border-pink-600 focus:bg-white dark:focus:bg-slate-900 dark:focus:text-white shadow-inner"
          />
